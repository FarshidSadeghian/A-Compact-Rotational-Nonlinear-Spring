function [ThetaR, r_thetaR]=RotNonLinearSpring(ThetaS,tau,K,R,l0,lOde,FigName,Xlabel)

% bayad ThetaS va tau be sorat amodi vared gardad, Thetas bayangar baze
% hayi ast k mikhahim be ezaye an tau bedahim va tau haman ghastavar k
% mikhahim tolid shavad mibashad, K haman stiifness ast, R bayangar radious
% roler mibashad , l0 tool fanar bad inke keshide shode va lode tool azad
% fanar ast k az l0 kamtar mibashad.
